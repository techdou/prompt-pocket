...
从 [GitHub Releases](https://github.com/techdou/prompt-pocket/releases/latest) 下载最新版 `v2.2.1`，安装包由 GitHub Actions 三平台构建：

| 平台 | 文件 |
| --- | --- |
| macOS Apple Silicon | `Prompt.Pocket_2.2.1_aarch64.dmg` |
| Windows x64 | `Prompt.Pocket_2.2.1_x64-setup.exe`（NSIS 安装器）或 `Prompt.Pocket_2.2.1_x64_en-US.msi` |
| Linux x64 | `Prompt.Pocket_2.2.1_amd64.deb`、`Prompt.Pocket-2.2.1-1.x86_64.rpm` 或 `Prompt.Pocket_2.2.1_amd64.AppImage`（免安装） |
...
Grab the latest `v2.2.1` from [GitHub Releases](https://github.com/techdou/prompt-pocket/releases/latest):

| Platform | File |
| --- | --- |
| macOS Apple Silicon | `Prompt.Pocket_2.2.1_aarch64.dmg` |
| Windows x64 | `Prompt.Pocket_2.2.1_x64-setup.exe` (NSIS installer) or `Prompt.Pocket_2.2.1_x64_en-US.msi` |
| Linux x64 | `Prompt.Pocket_2.2.1_amd64.deb`, `Prompt.Pocket-2.2.1-1.x86_64.rpm`, or `Prompt.Pocket_2.2.1_amd64.AppImage` (portable) |
